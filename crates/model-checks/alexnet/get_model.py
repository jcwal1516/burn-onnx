...
"""Download BVLC AlexNet from the ONNX Model Zoo."""
...
# ONNX Model Zoo: BVLC AlexNet, opset 12
...
def main():
    print("=" * 60)
    print("BVLC AlexNet Model Preparation")
    print("=" * 60)

    artifacts_dir = get_artifacts_dir(MODEL_NAME)

    raw_path = artifacts_dir / "alexnet_raw.onnx"
    model_path = artifacts_dir / "alexnet.onnx"
    ...
    print("\n" + "=" * 60)
    print(f"  BVLC AlexNet model preparation completed!")
    print(f"  Model: {model_path}")
    print(f"  Test data: {test_data_path}")
    print("=" * 60)
