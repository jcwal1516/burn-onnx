...
def export_model(output_path):
    """Export ShuffleNet v2 x1.0 to ONNX format."""
    print("Loading ShuffleNet v2 x1.0 from torchvision...")
...
def main():
    print("=" * 60)
    print("ShuffleNet v2 x1.0 Model Preparation")
    print("=" * 60)
    ...
    print("\n" + "=" * 60)
    print(f"  ShuffleNet model preparation completed!")
    print(f"  Model: {model_path}")
    print(f"  Test data: {test_data_path}")
    print("=" * 60)
