...
def export_model(output_path):
    """Export GoogLeNet (Inception v1) to ONNX format."""
    print("Loading GoogLeNet (Inception v1) from torchvision...")
...
def main():
    print("=" * 60)
    print("GoogLeNet (Inception v1) Model Preparation")
    print("=" * 60)

    artifacts_dir = get_artifacts_dir(MODEL_NAME)

    model_path = artifacts_dir / "inception_v1.onnx"
    ...
    print("\n" + "=" * 60)
    print(f"  Inception v1 model preparation completed!")
    print(f"  Model: {model_path}")
    print(f"  Test data: {test_data_path}")
    print("=" * 60)
