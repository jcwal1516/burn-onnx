...
def export_model(output_path):
    """Export SqueezeNet 1.0 to ONNX format."""
    print("Loading SqueezeNet 1.0 from torchvision...")
...
def main():
    print("=" * 60)
    print("SqueezeNet 1.0 Model Preparation")
    print("=" * 60)
    ...
    print("\n" + "=" * 60)
    print(f"  SqueezeNet model preparation completed!")
    print(f"  Model: {model_path}")
    print(f"  Test data: {test_data_path}")
    print("=" * 60)
