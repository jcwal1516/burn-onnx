...
def export_model(output_path):
    """Export MobileNet v2 to ONNX format."""
    print("Loading MobileNet v2 from torchvision...")
...
def main():
    print("=" * 60)
    print("MobileNet v2 Model Preparation")
    print("=" * 60)

    artifacts_dir = get_artifacts_dir(MODEL_NAME)

    model_path = artifacts_dir / "mobilenet_v2.onnx"
    ...
    print("\n" + "=" * 60)
    print(f"  MobileNet v2 model preparation completed!")
    print(f"  Model: {model_path}")
    print(f"  Test data: {test_data_path}")
    print("=" * 60)
